...
object IndicatorService {
    ...
    private fun deleteResources() {
        if (Indicators.totalWorkers > 0) {
            updateAmountCitizensOnSatisfaction()
            updateAmountCitizensOnFood()
            updateAmountFood()
        }
        paymentForBuildingsSatisfaction()
    }

    private fun updateAmountCitizensOnFood() {
    ...
    private fun updateAmountCitizensOnSatisfaction() {
    ...
    private fun paymentForBuildingsSatisfaction() {
